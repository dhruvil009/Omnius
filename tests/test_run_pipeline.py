...
@unittest.skipIf(PYTHON_313 is None, "python3.13 is required for end-to-end CLI coverage")
class RunPipelineTests(unittest.TestCase):
    ...
    def _write_config(self, *, home: Path, repo: Path) -> None:
